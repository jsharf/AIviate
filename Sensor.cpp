...
void sensorf_to_planestate(const sensorf &data, PlaneState p, float dt)
{
    ...
    float angleXZ = atan2(data.az, data.ax);
    // Filter the angles
    ...
    Vector3d a1 = Vector3d::i.rotate(Vector3d::j, -angleXZ);
    Vector3d a2 = Vector3d::j.rotate(Vector3d::i, angleYZ);
    Vector3d a3 = Vector3d::i.rotate(Vector3d::k, angleXY);
